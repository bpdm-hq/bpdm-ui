...
export const floatResting =
  "pointer-events-none absolute start-3 z-10 origin-left rtl:origin-right text-muted-foreground transition-all duration-150 top-1/2 -translate-y-1/2 text-sm peer-focus:text-foreground";
