...
Set `appearance="outline"` for a bordered button with a transparent fill. Works
with every variant.
...
export function ButtonOutlined() {
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <Button appearance="outline" variant="help">Help</Button>
      <Button appearance="outline" variant="destructive">Destructive</Button>
      <Button appearance="outline" variant="contrast">Contrast</Button>
    </div>
  );
}
```
...
```html title="button-outlined.html"
<div class="flex flex-wrap gap-3">
  <button bpdmButton appearance="outline" variant="primary">Primary</button>
  <button bpdmButton appearance="outline" variant="secondary">Secondary</button>
  <button bpdmButton appearance="outline" variant="success">Success</button>
  <button bpdmButton appearance="outline" variant="info">Info</button>
  <button bpdmButton appearance="outline" variant="warning">Warning</button>
  <button bpdmButton appearance="outline" variant="help">Help</button>
  <button bpdmButton appearance="outline" variant="destructive">Destructive</button>
  <button bpdmButton appearance="outline" variant="contrast">Contrast</button>
</div>
```
...
Set `appearance="ghost"` for a button with no border or fill — ideal for
low-emphasis actions and toolbars.
...
export function ButtonGhost() {
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <Button appearance="ghost" variant="help">Help</Button>
      <Button appearance="ghost" variant="destructive">Destructive</Button>
      <Button appearance="ghost" variant="contrast">Contrast</Button>
    </div>
  );
}
```
...
```html title="button-ghost.html"
<div class="flex flex-wrap gap-3">
  <button bpdmButton appearance="ghost" variant="primary">Primary</button>
  <button bpdmButton appearance="ghost" variant="secondary">Secondary</button>
  <button bpdmButton appearance="ghost" variant="success">Success</button>
  <button bpdmButton appearance="ghost" variant="info">Info</button>
  <button bpdmButton appearance="ghost" variant="warning">Warning</button>
  <button bpdmButton appearance="ghost" variant="help">Help</button>
  <button bpdmButton appearance="ghost" variant="destructive">Destructive</button>
  <button bpdmButton appearance="ghost" variant="contrast">Contrast</button>
</div>
```
