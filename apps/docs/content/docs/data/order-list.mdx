...
See the [Internationalization guide](/docs/getting-started/i18n) for the shared conventions.
...
| `messages` | `Partial<OrderListMessages>` | English | Override every built-in screen-reader string for i18n — see [Internationalization](#internationalization). |
