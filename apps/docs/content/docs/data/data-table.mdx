...
export function CompactTable() {
  return <DataTable columns={columns} data={members} rowKey={(r) => r.id} size="sm" />;
}
```
...
@Component({
  ...
  imports: [BpdmDataTable],
  template: `<bpdm-data-table [columns]="columns" [data]="members" [rowKey]="rowKey" size="sm" />`,
})
...
```ts title="data-table-striped.ts"
import { Component } from '@angular/core';
import { BpdmDataTable, type DataTableColumn } from '@bpdm/ng';
...
@Component({
  selector: 'striped-tables',
  imports: [BpdmDataTable],
  template: `
    <bpdm-data-table [columns]="columns" [data]="members" [rowKey]="rowKey" striped bordered />
    <bpdm-data-table [columns]="columns" [data]="members" [rowKey]="rowKey" [frame]="false" />
  `,
})
export class StripedTables {
  readonly rowKey = (r: Member) => r.id;
  readonly members: Member[] = [
    { id: 'm1', name: 'Hugo Lindberg', role: 'Owner', tasks: 128 },
    { id: 'm2', name: 'Sara Kovac', role: 'Editor', tasks: 86 },
...
export function FrozenTable() {
  return <DataTable columns={columns} data={members} rowKey={(r) => r.id} pinnable maxHeight={300} />;
}
```
...
@Component({
  ...
  imports: [BpdmDataTable],
  template: `<bpdm-data-table [columns]="columns" [data]="members" [rowKey]="rowKey" pinnable [maxHeight]="300" />`,
})
...
export function HugeTable() {
  return <DataTable columns={columns} data={members} rowKey={(r) => r.id} virtualized maxHeight={320} />;
}
```
...
@Component({
  selector: 'huge-table',
  imports: [BpdmDataTable],
  template: `<bpdm-data-table [columns]="columns" [data]="members" [rowKey]="rowKey" virtualized [maxHeight]="320" />`,
})
