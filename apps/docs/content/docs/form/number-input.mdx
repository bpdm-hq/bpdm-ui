...
export function Quantity() {
  return <NumberInput defaultValue="8" min="0" />;
}
```
...
@Component({
  ...
  template: `<bpdm-number-input defaultValue="8" min="0" />`,
})
...
@Component({
  ...
  template: `
    <div class="flex items-center gap-4">
      <bpdm-number-input buttonLayout="stacked" defaultValue="8" />
      <bpdm-number-input buttonLayout="horizontal" defaultValue="8" />
    </div>
  `,
})
export class Layout {}
...
@Component({
  ...
  template: `
    <div class="flex items-center gap-4">
      <bpdm-number-input size="sm" defaultValue="8" />
      <bpdm-number-input size="md" defaultValue="8" />
      <bpdm-number-input size="lg" defaultValue="8" />
    </div>
  `,
})
export class Sizes {}
...
export function States() {
  return <NumberInput disabled defaultValue="8" />;
}
```
...
@Component({
  selector: 'states',
  imports: [BpdmNumberInput],
  template: `<bpdm-number-input disabled defaultValue="8" />`,
})
export class States {}
```
